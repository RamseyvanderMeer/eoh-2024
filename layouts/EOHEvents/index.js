			...
			>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-5 mt-10">
					<Card key={'High School Design Competition'} title={'High School Design Competition'}>
						...
						every year! This event will happen on March 31st, 2023, and students can participate in groups
						of up to 5 students (recommended at least 3 students).This year, the EOH High School Design
						Competition will be held on Friday, March 31st, 2023. The theme for this year is ‘Roller
						Coasters’ : The team that designs a roller coaster that keeps a ball rolling on it for the
						longest time wins. The HSDC Rules Packet can be found by clicking{' '}
						<a
							className="underline text-blue-300 hover:text-blue-400 visited:text-purple-300"
							href="https://docs.google.com/document/u/2/d/13yBxDhnJrmcSrAtJnPvlOl7SyaxJnILt/edit?usp=sharing&ouid=104325850608307210887&rtpof=true&sd=true"
						>
							here
						</a>.
					</Card>
					<Card key={'Middle School Design Competition'} title={'Middle School Design Competition'}>
						<div>
							This year’s middle school design competition (MSDC) will be held on Friday, March 31st from
							11am-1pm. The theme is creative catapults! Students will be in teams of 3 or 4, given a
							variety of materials, each with a designated price. The goal is to build a cost-effective
							catapult that will launch a penny the farthest distance. The HSDC Rules Packet can be found
							by clicking{' '}
							<a
								className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600"
								href="https://docs.google.com/document/d/1Pq9fhodLYo4M--V0e41gv_nGiRDMe4ZX36hXorjv97w/edit?usp=sharing"
							>
								here
							</a>.
						</div>
